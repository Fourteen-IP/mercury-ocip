...
class TestPluginLoading:
    ...
    @patch('importlib.metadata.entry_points')
    @patch('mercury_ocip.agent.logger')  # Mock the logger instead of print
    def test_handles_plugin_load_failure(self, mock_logger, mock_entry_points, 
                                        mock_client, reset_agent_singleton, reset_installed_plugins):
        ...
        assert "Failed to load plugin failing_plugin" in mock_logger.error.call_args[0][0]
